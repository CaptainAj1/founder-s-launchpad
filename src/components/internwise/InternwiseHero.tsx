    ...
    <Container className="relative z-10 text-center pt-24 pb-32">
      <div className="animate-fade-in-up">
        ...
        <div className="flex items-center justify-center gap-3 text-white/60 text-sm mb-16">
          ...
          <a href="https://internwise.co.uk" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-white/10 px-4 py-1.5 rounded-full text-white/90 hover:bg-white/20 transition-colors"><img src="/united-kingdom.png" alt="UK" className="w-5 h-5" /> UK</a>
          <a href="https://internwise.eu" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-white/10 px-4 py-1.5 rounded-full text-white/90 hover:bg-white/20 transition-colors"><img src="/european.png" alt="Europe" className="w-5 h-5" /> Europe</a>
        </div>
      </div>
